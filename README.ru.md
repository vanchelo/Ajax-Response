...
```
Какие основные минусы в таком подходе?
...
Ниже приведу пример контроллера с разным подходом.
...
[Пример класса с описанной выше логикой](https://github.com/vanchelo/Ajax-Response/blob/master/src/MyAjaxResponse.php)
